...
var names = ["Family Book","satyanarayana - Grandfather", "Aravind - Father", "Pradeepthi - Mother", "Spandana - Sister"];

var age = [70, 68, 40, 38, 8]
...
function update()
{
    ...
    */
    ...
    console.log("The highest age is: ",40  );
    ...
    */
    ...
    console.log("The lowest age is: ",  8);
}